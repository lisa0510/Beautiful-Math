...
let thestring = 'FY'; // "axiom" or start of the string
let numloops = 9; // how many iterations to pre-compute
let therules = []; // array for rules
therules[0] = ['X', 'FY+F']; // first rule
therules[1] = ['Y', 'FX+Y-FY']; // second rule
